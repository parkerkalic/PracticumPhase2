...
function ContentTabs(_ref2) {
  ...
  var className = (0, _classnames.default)(customClassName, "".concat(prefix, "--content-switcher"), _defineProperty({}, "".concat(prefix, "--content-switcher--").concat(size), size));
...
var ContentTab = /*#__PURE__*/_react.default.forwardRef(function ContentTab(_ref3, ref) {
  ...
  var className = (0, _classnames.default)("".concat(prefix, "--content-switcher-btn"), _defineProperty({}, "".concat(prefix, "--content-switcher--selected"), selectedIndex === index));
