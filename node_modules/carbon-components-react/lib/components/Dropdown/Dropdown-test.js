...
describe('Dropdown', function () {
  ...
  it('should render with strings as items', function () {
    var wrapper = (0, _enzyme.mount)( /*#__PURE__*/_react2.default.createElement(_Dropdown.default, _extends({}, mockProps, {
      items: ['zar', 'doz']
    })));
    (0, _testHelpers.openMenu)(wrapper);
    expect(wrapper).toMatchSnapshot();
  ...
  describe('title', function () {
    ...
    var renderedLabel;
    beforeEach(function () {
      wrapper = (0, _enzyme.mount)( /*#__PURE__*/_react2.default.createElement(_Dropdown.default, _extends({
  ...
  describe('helper', function () {
    it('renders a helper', function () {
      var wrapper = (0, _enzyme.mount)( /*#__PURE__*/_react2.default.createElement(_Dropdown.default, _extends({
  ...
  describe('Component API', function () {
    ...
    it('should accept a `ref` for the underlying button element', function () {
      ...
      (0, _react.render)( /*#__PURE__*/_react2.default.createElement(_Dropdown.default, _extends({}, mockProps, {
        ref: ref
      })));
