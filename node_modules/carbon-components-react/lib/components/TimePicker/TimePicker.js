  ...
  _createClass(TimePicker, [{
    ...
    value: function render() {
      ...
      var timePickerInputProps = {
        className: (0, _classnames.default)("".concat(prefix, "--time-picker__input-field"), "".concat(prefix, "--text-input"), [enabled ? null : className], _defineProperty({}, "".concat(prefix, "--text-input--light"), light)),
...
_defineProperty(TimePicker, "contextType", _FeatureFlags.FeatureFlagContext);