...
var Toggle = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Toggle, [{
    ...
    value: function render() {
      ...
      var toggleClasses = (0, _classnames.default)("".concat(prefix, "--toggle-input"), _defineProperty({}, "".concat(prefix, "--toggle-input--small"), size === 'sm'));
      var checkedProps = {};
...
_defineProperty(Toggle, "contextType", _usePrefix.PrefixContext);
