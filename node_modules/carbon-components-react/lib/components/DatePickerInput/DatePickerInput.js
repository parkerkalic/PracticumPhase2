...
var DatePickerInput = /*#__PURE__*/function (_Component) {
  ...
  _createClass(DatePickerInput, [{
    ...
    value: function render() {
      ...
      var inputClasses = (0, _classnames.default)("".concat(prefix, "--date-picker__input"), (_classNames4 = {}, _defineProperty(_classNames4, "".concat(prefix, "--date-picker__input--").concat(size), size), _defineProperty(_classNames4, "".concat(prefix, "--date-picker__input--invalid"), invalid), _classNames4));
