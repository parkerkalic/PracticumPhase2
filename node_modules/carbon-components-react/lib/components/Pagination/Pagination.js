...
var Pagination = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Pagination, [{
    ...
    value: function render() {
      ...
      var classNames = (0, _classnames4.default)("".concat(prefix, "--pagination"), className, _defineProperty({}, "".concat(prefix, "--pagination--").concat(size), size));
      ...
      var backButtonClasses = (0, _classnames4.default)("".concat(prefix, "--pagination__button"), "".concat(prefix, "--pagination__button--backward"), _defineProperty({}, "".concat(prefix, "--pagination__button--no-index"), backButtonDisabled));
      var forwardButtonDisabled = disabled || statePage === totalPages;
      var forwardButtonClasses = (0, _classnames4.default)("".concat(prefix, "--pagination__button"), "".concat(prefix, "--pagination__button--forward"), _defineProperty({}, "".concat(prefix, "--pagination__button--no-index"), forwardButtonDisabled));
