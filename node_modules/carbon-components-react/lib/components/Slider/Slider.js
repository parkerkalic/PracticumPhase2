...
var Slider = /*#__PURE__*/function (_PureComponent) {
  ...
  _createClass(Slider, [{
    ...
    value: function render() {
      ...
      var sliderClasses = (0, _classnames.default)("".concat(prefix, "--slider"), _defineProperty({}, "".concat(prefix, "--slider--disabled"), disabled), [enabled ? null : className]);
      var inputClasses = (0, _classnames.default)("".concat(prefix, "--text-input"), "".concat(prefix, "--slider-text-input"), (_classNames3 = {}, _defineProperty(_classNames3, "".concat(prefix, "--text-input--light"), light), _defineProperty(_classNames3, "".concat(prefix, "--text-input--invalid"), isValid === false), _classNames3));
...
_defineProperty(Slider, "contextType", _FeatureFlags.FeatureFlagContext);