...
var ComboBox = /*#__PURE__*/_react.default.forwardRef(function (props, ref) {
  ...
  var className = (0, _classnames.default)("".concat(prefix, "--combo-box"), [enabled ? null : containerClassName], (_cx = {}, _defineProperty(_cx, "".concat(prefix, "--list-box--up"), direction === 'top'), _defineProperty(_cx, "".concat(prefix, "--combo-box--warning"), showWarning), _cx));
  ...
  return /*#__PURE__*/_react.default.createElement(_downshift.default, _extends({}, (0, _createPropAdapter.mapDownshiftProps)(downshiftProps), {
    ...
    }, titleText && /*#__PURE__*/_react.default.createElement(_Text.Text, _extends({
      as: "label",
