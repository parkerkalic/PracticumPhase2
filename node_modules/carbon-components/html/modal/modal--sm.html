...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-80lbv8rvrh3">Show
  modal</button>

<div data-modal id="modal-80lbv8rvrh3" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-80lbv8rvrh3-label" aria-describedby="modal-80lbv8rvrh3-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-80lbv8rvrh3-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-80lbv8rvrh3-heading">Modal heading</p>
