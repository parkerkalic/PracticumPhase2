...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-xcteb5fvtea">Show
  modal</button>

<div data-modal id="modal-xcteb5fvtea" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-xcteb5fvtea-label" aria-describedby="modal-xcteb5fvtea-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-xcteb5fvtea-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-xcteb5fvtea-heading">Modal heading</p>
