...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-ke4hjm6qqwm">Show
  modal</button>

<div data-modal id="modal-ke4hjm6qqwm" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-ke4hjm6qqwm-label" aria-describedby="modal-ke4hjm6qqwm-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-ke4hjm6qqwm-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-ke4hjm6qqwm-heading">Modal heading</p>
