...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-uetp6okzhlf">Show
  modal</button>

<div data-modal id="modal-uetp6okzhlf" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-uetp6okzhlf-label" aria-describedby="modal-uetp6okzhlf-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-uetp6okzhlf-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-uetp6okzhlf-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
