...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-epcxnzjlds5">Show
  modal</button>

<div data-modal id="modal-epcxnzjlds5" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-epcxnzjlds5-label" aria-describedby="modal-epcxnzjlds5-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-epcxnzjlds5-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-epcxnzjlds5-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
