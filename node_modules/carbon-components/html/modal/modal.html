...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-sjhira5kb8p">Show
  modal</button>

<div data-modal id="modal-sjhira5kb8p" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-sjhira5kb8p-label" aria-describedby="modal-sjhira5kb8p-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-sjhira5kb8p-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-sjhira5kb8p-heading">Modal heading</p>
