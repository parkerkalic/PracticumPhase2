...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-ny6kw9u01ad">Show
  modal</button>

<div data-modal id="modal-ny6kw9u01ad" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-ny6kw9u01ad-label" aria-describedby="modal-ny6kw9u01ad-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-ny6kw9u01ad-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-ny6kw9u01ad-heading">Modal heading</p>
