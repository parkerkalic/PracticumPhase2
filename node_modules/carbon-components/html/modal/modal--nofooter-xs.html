...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-l0ijmvo8a4o">Show
  modal</button>

<div data-modal id="modal-l0ijmvo8a4o" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-l0ijmvo8a4o-label" aria-describedby="modal-l0ijmvo8a4o-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-l0ijmvo8a4o-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-l0ijmvo8a4o-heading">Modal heading</p>
