...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-jdy3mad3nx">Show
  modal</button>

<div data-modal id="modal-jdy3mad3nx" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-jdy3mad3nx-label" aria-describedby="modal-jdy3mad3nx-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-jdy3mad3nx-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-jdy3mad3nx-heading">Modal heading</p>
