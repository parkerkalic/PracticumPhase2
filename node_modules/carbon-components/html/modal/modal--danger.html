...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-nnaepb04adi">Show
  modal</button>

<div data-modal id="modal-nnaepb04adi" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-nnaepb04adi-label" aria-describedby="modal-nnaepb04adi-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-nnaepb04adi-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-nnaepb04adi-heading">Modal heading</p>
